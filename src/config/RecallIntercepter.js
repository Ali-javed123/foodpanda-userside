...
const baseUrl = 'http://localhost:3001/RecallIntercepter/v1';
const RecallIntercepter = axios.create({
  baseURL: baseUrl,
  headers: {
...
RecallIntercepter.interceptors.request.use(
  function (config) {
...
RecallIntercepter.interceptors.response.use(
  function (response) {
...
export default RecallIntercepter;